				...
				.ajax({
					...
					success : function(data) {
						if (data == 1) {
							...
							window.location.href = 'http://localhost:8080/McQuay1/index.jsp';
						} else {
							$.messager.show({
								title : '提示消息',
								msg : '登录失败',
...
.main_content {
	background: url(Images/x_bg.jpg) repeat;
	margin-left: auto;
	margin-right: auto;
	text-align: left;
	float: none;
...
<body style="background: url(Images/bbg.jpg) no-repeat;">
	...
	<div class="container wrap1" style="height: 450px;">
		...
		<div
			...
			<button style="" class="login_btn" onclick="login();">登 录</button>
		</div>
		<!--row end-->
	</div>
	<!--container end-->
